...
if ( ! function_exists( 'finance_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function finance_posted_on() {
...
if ( ! function_exists( 'finance_posted_by' ) ) :
	/**
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'finance' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'finance_post_thumbnail' ) ) :
	 ...
	 */
	function finance_post_thumbnail() {
